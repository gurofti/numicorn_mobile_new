...
part of 'super_wrongs_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

WrongSectionsResponse _$WrongSectionsResponseFromJson(
        Map<String, dynamic> json) =>
    WrongSectionsResponse(
...
Map<String, dynamic> _$WrongSectionsResponseToJson(
        WrongSectionsResponse instance) =>
    <String, dynamic>{
      'data': instance.data,
...
SectionsModel _$SectionsModelFromJson(Map<String, dynamic> json) =>
    SectionsModel(
      ...
      wrongQuestionCount: json['wrongQuestionCount'] as String?,
      latestSolvedDate: json['latestSolvedDate'] as String?,
    );
...
Map<String, dynamic> _$SectionsModelToJson(SectionsModel instance) =>
    <String, dynamic>{
      ...
      'listNo': instance.listNo,
      'url': instance.url,
      'wrongQuestionCount': instance.wrongQuestionCount,
      'latestSolvedDate': instance.latestSolvedDate,
    };
